...
#define IPERF_TRAFFIC_TASK_PRIORITY 4//CONFIG_IPERF_TRAFFIC_TASK_PRIORITY
#define IPERF_TRAFFIC_TASK_STACK 4096
#define IPERF_REPORT_TASK_NAME "iperf_report"
#define IPERF_REPORT_TASK_PRIORITY 6//CONFIG_IPERF_REPORT_TASK_PRIORITY
...
#define IPERF_SOCKET_RX_TIMEOUT     10//CONFIG_IPERF_SOCKET_RX_TIMEOUT
#define IPERF_SOCKET_TCP_TX_TIMEOUT 10//CONFIG_IPERF_SOCKET_TCP_TX_TIMEOUT
