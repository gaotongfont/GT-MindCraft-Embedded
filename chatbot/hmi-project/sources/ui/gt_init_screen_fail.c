...
gt_obj_st * gt_init_screen_fail(void)
{
	...
	gt_player_add_item(player1, ".:img_02_01_2_225x116.jpg", sizeof(".:img_02_01_2_225x116.jpg"));
	gt_player_add_item(player1, ".:img_02_02_225x116.jpg", sizeof(".:img_02_02_225x116.jpg"));
	gt_player_add_item(player1, ".:img_02_03_225x116.jpg", sizeof(".:img_02_03_225x116.jpg"));
	gt_player_add_item(player1, ".:img_02_04_225x116.jpg", sizeof(".:img_02_04_225x116.jpg"));
	gt_player_add_item(player1, ".:img_02_05_225x116.jpg", sizeof(".:img_02_05_225x116.jpg"));
	gt_player_add_item(player1, ".:img_02_06_225x116.jpg", sizeof(".:img_02_06_225x116.jpg"));
	gt_player_add_item(player1, ".:img_02_07_225x116.jpg", sizeof(".:img_02_07_225x116.jpg"));
	gt_player_add_item(player1, ".:img_02_08_225x116.jpg", sizeof(".:img_02_08_225x116.jpg"));
	gt_player_add_item(player1, ".:img_02_09_225x116.jpg", sizeof(".:img_02_09_225x116.jpg"));
	gt_player_add_item(player1, ".:img_02_10_225x116.jpg", sizeof(".:img_02_10_225x116.jpg"));
	gt_player_add_item(player1, ".:img_02_11_225x116.jpg", sizeof(".:img_02_11_225x116.jpg"));
	gt_player_add_item(player1, ".:img_02_12_225x116.jpg", sizeof(".:img_02_12_225x116.jpg"));
	gt_player_add_item(player1, ".:img_02_13_225x116.jpg", sizeof(".:img_02_13_225x116.jpg"));
	gt_player_add_item(player1, ".:img_02_14_225x116.jpg", sizeof(".:img_02_14_225x116.jpg"));
	gt_player_add_item(player1, ".:img_02_15_225x116.jpg", sizeof(".:img_02_15_225x116.jpg"));
	gt_player_add_item(player1, ".:img_02_16_225x116.jpg", sizeof(".:img_02_16_225x116.jpg"));
	...
	gt_imgbtn_set_src(emptybtCopyCopy, ".:img_empty_18x18.png");
	gt_imgbtn_add_state_item(emptybtCopyCopy, ".:img_empty2_18x18.png");
	...
	gt_imgbtn_set_src(HistorybtCopyCopy, ".:img_History_22x19.png");
	gt_imgbtn_add_state_item(HistorybtCopyCopy, ".:img_History2_22x19.png");
