...
gt_obj_st * gt_init_keyboard(void)
{
	...
	gt_imgbtn_set_src(OK, ".:img_3110_44x44.png");
	gt_imgbtn_set_src_press(OK, ".:img_3116_44x44.png");
	gt_imgbtn_add_state_item(OK, ".:img_3117_44x44.png");
	...
	gt_imgbtn_set_src(Delete, ".:img_3111_44x44.png");
	gt_imgbtn_add_state_item(Delete, ".:img_3118_44x44.png");
	...
	gt_imgbtn_set_src(aA, ".:img_3109_44x44.png");
	gt_imgbtn_set_src_press(aA, ".:img_3112_44x44.png");
	gt_imgbtn_add_state_item(aA, ".:img_3114_44x44.png");
	...
	gt_imgbtn_set_src(Numbersymbolkey, ".:img_3113_44x44.png");
	gt_imgbtn_set_src_press(Numbersymbolkey, ".:img_3115_44x44.png");
