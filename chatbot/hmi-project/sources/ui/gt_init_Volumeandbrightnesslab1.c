...
/** Volumeandbrightnesslab1 */
gt_obj_st * Volumeandbrightnesslab1 = NULL;
...
{
	Volumeandbrightnesslab1 = gt_obj_create(NULL);
	gt_obj_add_event_cb(Volumeandbrightnesslab1, screen_home_0_cb, GT_EVENT_TYPE_INPUT_HOME_GESTURE_LEFT, NULL);
	gt_screen_set_bgcolor(Volumeandbrightnesslab1, gt_color_hex(0x000000));
	...
	/** VolumeSettings */
	/** 音量设置 */
	VolumeSettings = gt_label_create(Volumeandbrightnesslab1);
	...
	/** Volume_progress_bar */
	/** 音量进度条 */
	Volume_progress_bar = gt_progress_bar_create(Volumeandbrightnesslab1);
	...
	/** Screenbrightness */
	/** 屏幕亮度 */
	Screenbrightness = gt_label_create(Volumeandbrightnesslab1);
	...
	/** 亮度进度条 */
	Brightness_progress_bar = gt_progress_bar_create(Volumeandbrightnesslab1);
