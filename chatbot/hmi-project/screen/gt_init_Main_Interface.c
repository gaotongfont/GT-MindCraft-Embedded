...
gt_obj_st * gt_init_Main_Interface(void)
{
	...
	gt_imgbtn_add_state_item(imgbtn1, "f:img_WIFIsignal1_16x12.png");
	gt_imgbtn_add_state_item(imgbtn1, "f:img_WIFIsignal2_16x12.png");
	gt_imgbtn_add_state_item(imgbtn1, "f:img_WIFIsignal3_16x12.png");
	gt_imgbtn_add_state_item(imgbtn1, "f:img_WIFIsignal4_16x12.png");
	gt_imgbtn_add_state_item(imgbtn1, "f:img_WIFIsignal5_16x12.png");
